        ...
        <div className="flex gap-12 items-center">
          ...
          <div className="space-y-6 order-1 lg:order-2 flex-1 max-w-1/2">
            ...
            <p className="text-body-text text-text-color leading-relaxed">
              ...
              traffic that accelerates pavement deterioration, we've seen it all
              and developed solutions that work in real-world conditions. This
              local expertise has become the foundation of our franchise system.
            </p>
          </div>
        </div>
      </div>
