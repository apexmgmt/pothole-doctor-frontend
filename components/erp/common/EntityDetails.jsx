...
const EntityDetails = ({
  entityData,
  entityType = "lead", // lead, customer, etc.
  onEdit,
  customTabs = null, // Allow custom tabs to be passed
}) => {
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-2">
                  <h3 className="text-xl font-semibold text-light">
                    {entityData?.name || "Pothole Doctors"}
                  </h3>
                  <p className="text-gray">
                    {entityData?.email || "todd@potholedoctors.com"}
                  </p>
                </div>
              </div>
