...
export default class ReportService {
  ...
  static getSalesmanChartReport = async (params?: {
    ...
    try {
      ...
      if (params?.starting_date) {
        queryParams.append('starting_date', params.starting_date)
      }
  ...
  /**
   * Fetches salesman ranking report data with optional filters for starting date, end date, and location IDs.
   * @param params - Optional parameters for filtering the report data
   * @returns A promise that resolves to the report data
   */
  static getSalesmanRankingReport = async (params?: {
    starting_date?: string
    end_date?: string
    location_ids?: string[]
  }) => {
