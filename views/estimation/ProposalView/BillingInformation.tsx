    ...
    <div className='flex flex-col-reverse gap-4 sm:flex-row sm:justify-between mt-4 text-sm print:text-black'>
      ...
      <div className='flex flex-col sm:text-right'>
        ...
        <p className='wrap-break-word'>
          ...
          {proposal?.estimate?.address?.state?.name ? ', ' + proposal?.estimate?.address?.state?.name : ''}
          {proposal?.estimate?.address?.zip_code ? ', ' + proposal?.estimate?.address?.zip_code : ''}
        </p>
        {proposal?.estimate?.address?.email || proposal?.estimate?.client?.email ? (
          <p>{proposal?.estimate?.address?.email || proposal?.estimate?.client?.email}</p>
        ) : null}
        {proposal?.estimate?.address?.phone || proposal?.estimate?.client?.phone ? (
          <p>{proposal?.estimate?.address?.phone || proposal?.estimate?.client?.phone}</p>
        ) : null}
      </div>
    </div>
  )
