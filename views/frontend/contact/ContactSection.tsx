...
const ContactSection: React.FC = () => {
  ...
  const [submitStatus, setSubmitStatus] = useState<ContactFormSubmitStatus | null>(null)
        ...
        <div className='flex gap-10 items-start min-[991px]:flex-row flex-col'>
          <div className='space-y-2.5 md:space-y-4 flex-1 xl:max-w-[520px]  max-[991px]:w-full  min-[991px]:sticky  min-[991px]:top-5'>
            ...
            <p className='text-text-color text-body-text leading-relaxed max-w-[460px]'>
              We're here to answer your questions and provide fast, reliable pavement solutions.
            </p>
            ...
            <div className='space-y-4 md:space-y-6 mt-7 sm:mt-6 min-[991px]:mt-[90px] '>
              <div className='flex items-center gap-2'>
                ...
                <span className='text-body-text font-medium'>(740) 330-5155</span>
              </div>
              ...
              <div className='flex items-center gap-2'>
                ...
                <span className='text-body-text font-medium'>todd@potholedoctors.com</span>
              </div>
              ...
              <div className='flex items-center gap-2'>
                ...
                <span className='text-body-text font-medium'>708-D Fairground Rd, Lucasville, OH 45648</span>
              </div>
            </div>
          </div>

          <div className='flex-1 w-full'>
            <div className='text-[28px] font-semibold text-title font-primary uppercase mb-[30px]'>CONTACT US</div>
            <form onSubmit={handleSubmit} className='space-y-4 xl:space-y-6'>
              <div className='grid sm:grid-cols-2 gap-4 xl:gap-6'>
                <div className='space-y-2 xl:space-y-3'>
                  <label htmlFor='firstName' className='block text-sm font-medium text-title uppercase'>
                    FIRST NAME
                  </label>
                  <input
                    type='text'
                ...
                <div className='space-y-2 xl:space-y-3'>
                  <label htmlFor='lastName' className='block text-sm font-medium text-title uppercase'>
                    LAST NAME
                  </label>
                  <input
                    type='text'
              ...
              <div className='grid sm:grid-cols-2  gap-4 xl:gap-6'>
                <div className='space-y-2 xl:space-y-3'>
                  <label htmlFor='phone' className='block text-sm font-medium text-title uppercase'>
                    PHONE NO
                  </label>
                  <input
                    type='tel'
                ...
                <div className='space-y-2 xl:space-y-3'>
                  <label htmlFor='email' className='block text-sm font-medium text-title uppercase'>
                    EMAIL
                  </label>
                  <input
                    type='email'
              ...
              <div className='space-y-2'>
                <label htmlFor='company' className='block text-sm font-medium text-title uppercase'>
                  COMPANY NAME
                </label>
                <input
                  type='text'
              ...
              <div className='space-y-2'>
                <label htmlFor='projectType' className='block text-sm font-medium text-title uppercase'>
                  PROJECT TYPE
                </label>
                <div className='relative'>
                  ...
                  >
                    ...
                    <option value='catch-basin-repairs'>Catch Basin Repairs</option>
                    <option value='birdbath-repairs'>Birdbath Repairs</option>
                    <option value='speed-bump-installation'>Speed Bump Installation</option>
                    <option value='parking-block-installation'>Parking Block Installation</option>
                    <option value='parking-block-repainting'>Parking Block Repainting</option>
              ...
              <div className='space-y-2'>
                <label htmlFor='projectDescription' className='block text-sm font-medium text-title uppercase'>
              ...
              <div className='space-y-2'>
                <label htmlFor='timeline' className='block text-sm font-medium text-title uppercase'>
              ...
              <div className='space-y-2'>
                <label htmlFor='hearAboutUs' className='block text-sm font-medium text-title uppercase'>
              ...
              <div className='flex items-start gap-3'>
                <div className='flex items-center space-x-3'>
                  <label className='relative cursor-pointer'>
                    ...
                    <div
                      className={`w-4 h-4 md:w-6 md:h-6 border-2 rounded transition-all duration-200 ${
                        formData.privacy ? 'bg-primary border-primary' : 'border-border hover:border-primary'
                      }`}
                    >
                      {formData.privacy && (
                        <svg
                  ...
                  <label htmlFor='privacy' className='text-sm text-title leading-relaxed cursor-pointer select-none'>
              ...
              <button
                ...
                className={`py-3 md:py-4 px-4 md:px-6 rounded-lg font-semibold tracking-wide uppercase transition-colors flex items-center justify-center gap-1.5 w-max cursor-pointer ${
                  isSubmitting ? 'bg-gray-400 cursor-not-allowed' : 'bg-primary text-white hover:bg-primary/85'
                }`}
              >
                {isSubmitting ? (
                  <>
