...
const Login = () => {
  ...
  return (
    <>
      ...
      <Field label='Email' type='email' name='email' value={form.email} onChange={handle} placeholder='Enter email' />
      <Field
        label='Password'
        type='password'
        name='password'
      ...
      <div className='mt-4'>
        <CustomButton type='submit' variant='primary' fullWidth className='!py-2'>
          Login
        </CustomButton>
      </div>
    </>
