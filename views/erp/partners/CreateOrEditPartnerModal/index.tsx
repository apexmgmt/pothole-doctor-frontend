...
const CreateOrEditPartnerModal = ({
  ...
  const onSubmit = async (values: FormValues) => {
    const payload: PartnerPayload = {
      ...
      insurance_expiration: formatDateTime(values.insurance_expiration ?? null, 'YYYY-MM-DD HH:mm:ss'),
      w9_expiration: formatDateTime(values.w9_expiration ?? null, 'YYYY-MM-DD HH:mm:ss'),
