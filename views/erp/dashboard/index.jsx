...
const DashboardIndex = () => {
  ...
  return (
    <div className='p-6 space-y-4'>
      ...
      {/* Customers Table */}
      <div>
        <h2 className='text-xl font-semibold text-light mb-4'>Customers Table</h2>
        <CustomTable
          data={customersData}
      ...
      <div>
        ...
        <CustomTable data={[]} columns={customerColumns} loading={true} className='mb-6' />
      </div>

      {/* Empty State Example */}
      <div>
        <h2 className='text-xl font-semibold text-light mb-4'>Empty State</h2>
        <CustomTable data={[]} columns={customerColumns} emptyMessage='No data found!' className='mb-6' />
      </div>
    </div>
  )
}
