      ...
      <div className='grid grid-cols-3 gap-6'>
        ...
        <div className='space-y-6'>
          ...
          <div className='bg-bg-2 rounded-lg border border-border p-6'>
            <div className='flex items-center justify-between mb-6'>
              ...
              <CustomButton variant='outline' size='sm' onClick={handleNewProposal} className='flex items-center gap-2'>
                <PlusIcon size={16} />
                New
              </CustomButton>
            </div>
            ...
            <div className='mt-6 pt-6 border-t border-border'>
              ...
              <div className='flex items-center justify-between'>
                <span className='text-2xl font-semibold text-light'>$15.00</span>
                <span className='px-3 py-1 bg-green-600/20 text-green-400 text-sm rounded-full'>In progress</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='space-y-6 '>
          <div className='bg-bg-2 rounded-lg border border-border p-6'>
            ...
            <div className='flex justify-end'>
              <CustomButton variant='outline' size='sm' onClick={handlePerformTakeOf}>
                Perform take-of
              </CustomButton>
            </div>
          ...
          <div className='bg-bg-2 rounded-lg border border-border p-6'>
            ...
            <div className='space-y-4'>
              {notes.map(note => (
                <div key={note.id} className='p-4 bg-bg-3 rounded-lg border border-border'>
                  <p className='text-light text-sm mb-3 leading-relaxed'>{note.content}</p>
                  <div className='flex items-center justify-between text-xs'>
                    <span className='text-gray'>
                      Created bt <span className='text-light'>{note.author}</span>
                    </span>
        ...
        <div className='space-y-6 bg-bg-2 rounded-lg border border-border p-6'>
          ...
          <div className='flex items-center justify-between'>
            ...
            <CustomButton variant='outline' size='sm' onClick={handleEditDetails} className='flex items-center gap-2'>
              <EditIcon size={16} />
              Edit
            </CustomButton>
          </div>
