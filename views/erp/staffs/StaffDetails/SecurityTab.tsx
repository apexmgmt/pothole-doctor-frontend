...
const SecurityTab: React.FC<SecurityTabProps> = ({ staffId, canEditStaff = false }) => {
  ...
  const onSubmitSecurity = async (values: SecurityFormValues) => {
    try {
      await StaffService.changePassword(staffId, values.new_password, values.password_confirmation)
